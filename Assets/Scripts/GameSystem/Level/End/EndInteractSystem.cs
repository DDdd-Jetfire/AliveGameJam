...
public class EndInteractSystem : MonoBehaviour
{

    public static EndInteractSystem instance;

    public GameObject cursor;
    public GameObject freeCursor;
    ...
    void Start()
    {
        GlobalEventManager.instance.RegisterEvent("SetCursorFree", SetFree);
        Cursor.visible = false;
        freeCursor.SetActive(false);
    ...
    public void SetFree()
    {
        freeCursor.transform.position = cursor.transform.position;
        freeCursor.SetActive(true);
    ...
    {
        GlobalEventManager.instance.UnregisterEvent("SetCursorFree", SetFree);
    }
}
